...
import {MailIcon} from '../../pages/MailIcon';
...
const GoogleGeminiEffect = ({
  ...
  return (
    <div className={cn("sticky top-20", className)}>
      ...
      <div className="w-full z-50 h-[890px] -top-60 md:-top-40  flex flex-col items-center justify-center bg-red-transparent absolute ">
        <div className="w-[30%] flex flex-row justify-center align-middle items-center gap-2"><br />
          <Input color="primary" type="email" label="Email" placeholder="you@example.com" startContent={ <MailIcon className="text-2xl text-default-400 pointer-events-none flex-shrink-0" /> } />
          <Button endContent={<Icon icon={'fa:send'} fontSize={'32px'} />} color="primary" variant="shadow"><b>Send</b></Button>
        </div><br /><br /><br />
        <Link to={'https://gen-up-nexus.vercel.app/'}>
