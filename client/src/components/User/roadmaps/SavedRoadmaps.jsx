...
const SavedRoadmaps = () => {
  ...
  return (
    <div>
      <Layout>
        <Background />
        <div className="flex justify-between m-5 text-2xl text-center"></div>
        {roadMapData &&  (
          <>
            <div className="flex">
              {!roadMapData[0].week1.data.day1.isComplete && (
                <Card className="starter flex flex-col justify-around align-middle items-center h-[350px] rounded-lg p-3 ml-1 bg-opacity-60">
